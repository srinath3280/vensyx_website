...
function EnterpriseMobility() {
    var [enterprisemobility, setEnterprisemobility] = useState()
    useEffect(() => {
        axios({
            method: 'GET',
    ...
    console.log(enterprisemobility)
    return (
        <>
            <div id='socialMedia'>
            ...
            <main>
                <div id="enterprisemobility">
                    <h1 style={{ color: 'white' }}>Enterprise Mobility</h1>
