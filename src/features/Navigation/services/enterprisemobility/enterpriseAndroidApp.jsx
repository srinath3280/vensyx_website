...
function EnterpriseAndroidApp() {
    var [enterpriseandroid, setEnterpriseandroid] = useState()
    useEffect(() => {
        axios({
            method: 'GET',
            url: '/files/enterpriseMobility/enterprise_androidApp.txt'
        }).then((res) => {
            setEnterpriseandroid(res.data)
        })
    }, [])
    console.log(enterpriseandroid)
    return (
        <>
            <div id='socialMedia'>
            ...
            <main>
                <div id="enterpriseandroid">
                    <h1 style={{ color: 'white' }}>Enterprise Android App Development</h1>
...
export default EnterpriseAndroidApp