...
function Windows8App() {
    var [windows8app, setWindows8app] = useState()
    useEffect(() => {
        axios({
            method: 'GET',
    ...
    return (
        <>
            ...
            <main>
                <div id="windows8app">
                    <h1 style={{ color: 'white' }}>Windows8 App Development</h1>
