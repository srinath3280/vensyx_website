...
function Telecommunications() {
    var [telecommunication, setTelecommunication] = useState()
    useEffect(() => {
        axios({
            method: 'GET',
    ...
    return (
        <>
            ...
            <main>
                <div id="telecommunication">
                    <h1 style={{ color: 'white' }}>Telecommunication</h1>
                    <div style={{ display: 'flex', flexDirection: 'row' }}>
                                ...
                                telecommunication && telecommunication.map((data) => {
                                    return (
                                        <>
                                            {Array.isArray(data) ? (
                                                <div>
                                                    <h4 style={{ color: 'white' }}>VENSYX Data Solutions Provides:</h4>
                                                    <ul>
                        ...
                        <div style={{ width: '40%', paddingRight: '50px', paddingTop: '50px' }}>
                            <img src="/images/telecommunication1.jpg" alt="telecommunication" width="100%" height="500px" />
                        </div>
                    </div>
                </div>
            </main>
