            ...
            <main>
                <div id="aboutus">
                    ...
                    <div id="aboutusblock" style={{ display: 'flex', flexDirection: 'row' }}>
                        <div id="aboutuscontent" style={{ width: '60%', padding: '50px', textAlign: 'justify', fontSize: '25px' }}>
                            {
                        ...
                        <div id="aboutusimage" style={{ width: '40%', paddingRight: '50px', paddingTop: '50px' }}>
                            <img src="/images/about1.jpg" alt="aboutus" width="100%" height="600px" />
                        </div>
                    </div>
                </div>
            </main>
