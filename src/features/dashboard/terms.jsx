        ...
        <>
            ...
            <main>
                <div style={{ marginTop: '75px', backgroundColor: 'rgb(8, 8, 71)', height: 'auto' }}>
                    ...
                    <div id="terms">
                        <h3>WELCOME TO VENSYX DATA SOLUTIONS!</h3>
                        <p>
                            These terms and conditions outline the rules and regulations for the use of VENSYX DATA SOLUTIONS Pvt Ltd's Website, located at www.vensyx.com OR VENSYX Data Solutions OR Contents of VENSYX Data Solutions
                            By accessing this website we assume you accept these terms and conditions. Do not continue to use VENSYX DATA SOLUTIONS if you do not agree to take all of the terms and conditions stated on this page.
                        ...
                        <h2>Cookies</h2>
                        <p>
                            We employ the use of cookies. By accessing VENSYX DATA SOLUTIONS, you agreed to use cookies in agreement with the VENSYX DATA SOLUTIONS Pvt Ltd's Privacy Policy.
                        </p>
                        <p>
                        ...
                        <h2>License</h2>
                        <p>
                            Unless otherwise stated, VENSYX DATA SOLUTIONS Pvt Ltd and/or its licensors own the intellectual property rights for all material on VENSYX DATA SOLUTIONS. All intellectual property rights are reserved. You may access this from VENSYX DATA SOLUTIONS for your own personal use subjected to restrictions set in these terms and conditions.
                        </p>
                        <p>
                            You must not:
                        </p>
                        <ul>
                            <li>Republish material from VENSYX DATA SOLUTIONS</li>
                            <li>Sell, rent or sub-license material from VENSYX DATA SOLUTIONS</li>
                            <li>Reproduce, duplicate or copy material from VENSYX DATA SOLUTIONS</li>
                            <li>Redistribute content from VENSYX DATA SOLUTIONS</li>
                        </ul>
                        <p>
                            This Agreement shall begin on the date hereof.
                        </p>
                        <p>
                            Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. VENSYX DATA SOLUTIONS Pvt Ltd does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of VENSYX DATA SOLUTIONS Pvt Ltd,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, VENSYX DATA SOLUTIONS Pvt Ltd shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
                        </p>
                        <p>
                            VENSYX DATA SOLUTIONS Pvt Ltd reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
                        </p>
                        <p>
                        ...
                        <p>
                            You hereby grant VENSYX DATA SOLUTIONS Pvt Ltd a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
                        </p>
                        ...
                        <p>
                            If your organization is interested in linking to our website, you must inform us by sending an e-mail to VENSYX DATA SOLUTIONS Pvt Ltd. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
                        </p>
                        <p>
                            No use of VENSYX DATA SOLUTIONS Pvt Ltd's logo or other artwork will be allowed for linking in the absence of a trademark license agreement.
                        </p>
                        <h2>iFrames</h2>
                        <p>
