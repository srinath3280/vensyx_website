        ...
        <>
            ...
            <main>
                <div style={{ marginTop: '75px', backgroundColor: 'rgb(8, 8, 71)', height: 'auto' }}>
                    ...
                    <div id="privacy">
                        <p>
                            VENSYX DATA SOLUTIONS ("us", "we", or "our") operates the http://www.vensyx.com website (the "Service"). “You” , “Your” refers to the customers / Clients
                            This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.
                        </p>
                        <p>
                            We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from http://www.vensyx.com
                        </p>
                        ...
                        <h3>1.3 Tracking & Cookies Data</h3>
                        <p>
                            We use cookies and similar tracking technologies to track the activity on our Service and hold certain information.
                        </p>
                        <p>
                            Cookies are files with small amount of data which may include an anonymous unique identifier. Cookies are sent to your browser from a website and stored on your device. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze our Service.
                        </p>
                        <p>
                        ...
                        <h2>2. Use of Data</h2>
                        <p>
                            VENSYX DATA SOLUTIONS uses the collected data for various purposes:
                        </p>
                        <ul>
                        ...
                        <p>
                            VENSYX DATA SOLUTIONS will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.
                        </p>
                        <h2>4. Disclosure Of Data</h2>
                        <p>
                            VENSYX DATA SOLUTIONS may disclose your Personal Data in the good faith belief that such action is necessary to:
                        </p>
                        <ul>
                            <li>To comply with a legal obligation</li>
                            <li>
                                To protect and defend the rights or property of VENSYX DATA SOLUTIONS
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>By email: info@vensyx.com</li>
                            <li>By phone number: +91-9000316721</li>
                        </ul>
                    </div>
                </div>
            </main>
